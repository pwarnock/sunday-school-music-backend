...
export default function HeroSection() {
  return (
    <section className="min-h-screen flex items-center relative pt-24 bg-gray-50 dark:bg-gray-900">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Link
                href="/signup"
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200"
              ...
              <Link
                href="#how-it-works"
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-gray-700 dark:text-white border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-green-500 hover:text-green-500 transition-all duration-200"
              >
                See How It Works
              </Link>
            </div>
            ...
            <div className="flex flex-wrap gap-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm text-gray-500">Songs Created</div>
              ...
              <div className="flex items-center gap-3">
                <span className="text-4xl">⭐</span>
                <div>
                  <div className="text-sm text-gray-500">Happy Teachers</div>
